...
float subTrim1;                   //levelout servo1
float subTrim2;                   //levelout servo2
float subTrim3;                   //levelout servo3
...
void control_Mixer() {
  ...
  //mixing Servos
  out_command[SERVO1] = (transitionFadeValue*0.5) - transitionFadeValue*pitch_PID + transitionFadeValue*yaw_PID + (1-transitionFadeValue)*roll_PID*4 + subTrim1;
  out_command[SERVO2] = (transitionFadeValue*0.5) - transitionFadeValue*pitch_PID - transitionFadeValue*yaw_PID - (1-transitionFadeValue)*roll_PID*4 + subTrim2;
