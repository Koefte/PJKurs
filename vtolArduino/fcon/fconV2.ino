...
#define IMU_ALIGN  IMU_ALIGN_CW180 //IMU_ALIGN_CW0, IMU_ALIGN_CW90, IMU_ALIGN_CW180, IMU_ALIGN_CW270, IMU_ALIGN_CW0FLIP, IMU_ALIGN_CW90FLIP, IMU_ALIGN_CW180FLIP, IMU_ALIGN_CW270FLIP
...
enum out_enum {MOTOR1,MOTOR2,SERVO1,SERVO2,SERVO3}; 
...
float subTrim1=0.15;                   //levelout servo1
float subTrim2=0.85;                   //levelout servo2
float subTrim3=0.6;       
float subTrim4=0.4;   
...
void control_Mixer() {
  ...
  // mixing Motors
  out_command[MOTOR1] = rcin_thro + transitionFadeValue*roll_PID + (1-transitionFadeValue)*yaw_PID;
  out_command[MOTOR2] = rcin_thro - transitionFadeValue*roll_PID - (1-transitionFadeValue)*yaw_PID;
  //mixing Servos
  out_command[SERVO1] = (transitionFadeValue*(yaw_PID*0.5+subTrim1-pitch_PID)) + (1-transitionFadeValue)*(roll_PID*4+subTrim3) ;
  out_command[SERVO2] = (transitionFadeValue*(yaw_PID*0.5+subTrim2+pitch_PID)) + (1-transitionFadeValue)*(roll_PID*4+subTrim4);
  out_command[SERVO3] = 3*pitch_PID + subTrim3;
