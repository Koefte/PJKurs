...
#define HW_PIN_IMU_EXTI  23 //external interrupt pin
...
#define HW_PIN_OUT_LIST  {32,33,25,26,27,14} //list of output pins
...
float addAndGetSmoothedValue(float newValue) {
...
void control_Mixer() {
  ...
  out_command[SERVO2] = (transitionFadeValue*(yaw_PID*0.5+subTrim3)) + (1-transitionFadeValue)*(-roll_PID+subTrim1) ;
  out_command[SERVO3] = (transitionFadeValue*(yaw_PID*0.5+subTrim4)) + (1-transitionFadeValue)*(-roll_PID+subTrim2);
  out_command[SERVO4] = 4*pitch_PID + subTrim5;
